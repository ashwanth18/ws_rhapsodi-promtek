...
def generate_launch_description():
    ...
    package_name_moveit_config = 'niryo_robot_moveit_interface'
    ...
    def configure_setup(context):
        ...
        config_path = os.path.join(pkg_share_moveit_config, 'config', 'niryo_ned3pro')
